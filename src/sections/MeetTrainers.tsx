...
export default function MeetTrainers() {
  return (
    <div className='w-full bg-gradient-to-bl from-[#5239C3] to-[#AE5DD4]  py-4 grid grid-cols-1 place-items-center lg:pb-0'>
        ...
        <div className='flex items-center justify-center mt-6 lg:order-3 lg:-translate-y-4 lg:-translate-x-8'>
